...
public:
  ...
  Coordinate textRenderer(const uint8_t font8Bit[][16], const char *text);
  Coordinate textRenderer(const uint8_t font8Bit[][16], const char *text, RGBA characterColor, RGBA backgroudColor);
};
